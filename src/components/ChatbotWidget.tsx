...
const botReply = (input: string) => {
  ...
  if (/(hi|hello|salam|assalam|hey)/.test(q)) {
    return "Hello! I am the Blue Shine Dental Clinic assistant. You can ask about implants, pain, braces, cleaning, timings, or booking.";
  }
  ...
  if (/(pain|dard|toothache|sujaan|swelling)/.test(q)) {
    return "If you have severe pain or swelling, do not delay. Avoid very hot or cold foods and visit the clinic for an emergency checkup, or call: 095995 82158.";
  }
  ...
  if (/(appointment|book|booking|schedule)/.test(q)) {
    return "To book an appointment, fill the Book Now form on this page or call directly: 095995 82158.";
  }
  ...
  if (/(emergency|urgent|bleeding|broken tooth)/.test(q)) {
    return "In an emergency, contact us immediately: 095995 82158. We handle urgent cases including dental pain, fractures, and infections.";
  }
