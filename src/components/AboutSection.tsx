...
import clinicInterior from "@/assets/blue-about.jpeg";
import clinicReception from "@/assets/blue-about.jpeg";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`space-y-6 ${isVisible ? "animate-reveal-right" : "opacity-0"}`}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed text-pretty">
              At Blue Shine Dental Clinic in North Delhi - Rohini, Dr. Pravesh (MDS) and our expert team combine clinical excellence with genuine compassion. Our state-of-the-art facility is designed for your comfort, featuring the latest diagnostic and treatment technology alongside a warm, welcoming atmosphere.
            </p>
